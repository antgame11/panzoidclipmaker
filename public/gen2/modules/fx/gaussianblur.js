...
THREE.GaussianBlurPass || (THREE.GaussianBlurPass = function(e, t) {
    this.material_h = e,
...
THREE.GaussianBlurPass.prototype = {
    render: function(e, t, a, s) {
        for (var i = 0; i < 3; i++)
            ...
            e.render(this.scene, this.camera, a, s)
    }
}),
this.load = function(e) {
    if (this.pass = new THREE.GaussianBlurPass(PZ.shaders.load(this.shaderfile, {
        tDiffuse: {
            type: "t",
            value: null
        },
