...
THREE.UnrealBloomPass || (THREE.UnrealBloomPass = function(t, e, r, a) {
    ...
    this.renderTargetBright = new THREE.WebGLRenderTarget(i,s,o),
    this.renderTargetBright.texture.generateMipmaps = !1;
    for (h = 0; h < this.nMips; h++) {
        var n = new THREE.WebGLRenderTarget(i,s,o);
        n.texture.generateMipmaps = !1,
        this.renderTargetsHorizontal.push(n),
        (n = new THREE.WebGLRenderTarget(i,s,o)).texture.generateMipmaps = !1,
    ...
    for (var u = [3, 5, 7, 9, 11], i = Math.round(this.resolution.x / 2), s = Math.round(this.resolution.y / 2), h = 0; h < this.nMips; h++)
        this.separableBlurMaterials.push(this.getSeperableBlurMaterial(u[h])),
        this.separableBlurMaterials[h].uniforms.texSize.value = new THREE.Vector2(i,s),
        i = Math.round(i / 2),
        s = Math.round(s / 2);
...
THREE.UnrealBloomPass.prototype = Object.assign(Object.create(THREE.Pass.prototype), {
    ...
    setSize: function(t, e) {
        var r = Math.round(t / 2)
          , a = Math.round(e / 2);
        this.renderTargetBright.setSize(r, a);
        for (var o = 0; o < this.nMips; o++)
            this.renderTargetsHorizontal[o].setSize(r, a),
            this.renderTargetsVertical[o].setSize(r, a),
            this.separableBlurMaterials[o].uniforms.texSize.value = new THREE.Vector2(r,a),
            r = Math.round(r / 2),
            a = Math.round(a / 2)
    },
    render: function(t, e, r, a, o) {
        ...
        for (var s = this.renderTargetBright, n = 0; n < this.nMips; n++)
            ...
            this.separableBlurMaterials[n].uniforms.direction.value = THREE.UnrealBloomPass.BlurDirectionX,
            ...
            this.separableBlurMaterials[n].uniforms.direction.value = THREE.UnrealBloomPass.BlurDirectionY,
...
this.load = function(t) {
    if (this.pass = new THREE.UnrealBloomPass(new THREE.Vector2(1,1),1.5,.4,.85),
    "string" == typeof t) {
